...
func (c *riverClient) Range(ctx context.Context, in *RangeOption, opts ...grpc.CallOption) (*RangeResult, error) {
	out := new(RangeResult)
	err := c.cc.Invoke(ctx, River_Range_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRiverServer) Range(context.Context, *RangeOption) (*RangeResult, error) {
...
func _River_Range_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RangeOption)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RiverServer).Range(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: River_Range_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RiverServer).Range(ctx, req.(*RangeOption))
	}
	return interceptor(ctx, in, info, handler)
}
